...
>
> This is the first design sketch, written before the game was built. It says
> countries, planets, CEOs, relocation and prizes, none of which are in the
> game. The current design is `docs/world_and_calibration.md` plus
> `content/rounds.json`. Kept only as a record of what was considered.
